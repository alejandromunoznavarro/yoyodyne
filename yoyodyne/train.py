...
def main(
    ...
    for (
        arg,
        val,
    ) in click.get_current_context().params.items():
    ...
    dev_set.load_index(trainer.loggers[0].log_dir, lang)
    # Trains model.
    ...
    # Writes development set predictions using the best model if a path was
    # specified.
